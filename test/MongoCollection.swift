...
struct MongoQueryFlag: OptionSetType {
	let rawValue: Int
	...
	init(_ queryFlag: mongoc_query_flags_t) {
...
class MongoIndexOptionsGeo {
	var rawOpt = UnsafeMutablePointer<mongoc_index_opt_geo_t>.alloc(1)

	init(twodSphereVersion: UInt8? = nil, twodBitsPrecision: UInt8? = nil, twodLocationMin: Double? = nil, twodLocationMax: Double? = nil, haystackBucketSize: Double? = nil) {
...
class MongoIndexOptions {
	...
	init(name: String? = nil, background: Bool? = nil, unique: Bool? = nil, dropDups: Bool? = nil, sparse: Bool? = nil,
...
enum MongoIndexStorageOptionType: UInt32 {
...
class MongoCollection {
	...
	typealias Result = MongoResult

	init(client: MongoClient, databaseName: String, collectionName: String) {
	...
	func update(update: BSON, selector: BSON, flag: MongoUpdateFlag = .None) -> Result {
		var error = bson_error_t()
	...
	func remove(selector: BSON, flag: MongoRemoveFlag = .None) -> Result {
		var error = bson_error_t()
	...
	func save(document: BSON) -> Result {
		var error = bson_error_t()
	...
	func validate(options: BSON) -> Result {
		var error = bson_error_t()
		let reply = BSON()
	...
	func find(query: BSON, fields: BSON? = nil, flags: MongoQueryFlag = MongoQueryFlag.None, skip: Int = 0, limit: Int = 0, batchSize: Int = 0) -> MongoCursor? {
	...
	func count(query: BSON, fields: BSON? = nil, flags: MongoQueryFlag = MongoQueryFlag.None, skip: Int = 0, limit: Int = 0, batchSize: Int = 0) -> Result {
		var error = bson_error_t()
